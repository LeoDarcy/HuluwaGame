...
public class MainCanvas{
    ...
    public MainCanvas(Canvas c, TextArea t, Text cl) {
        ...
        reader = null;
        PrepareText();
        music = new AudioClip(new File("src/main/resources/music/葫芦娃.mp3").toURI().toString());
    ...
    public void StartFight() {
        ...
        music.stop();
        music = new AudioClip(new File("src/main/resources/music/仙妖乱.mp3").toURI().toString());
        music.setCycleCount(1000);
        music.play();
        battleField.Reload();
        PrepareBat();
